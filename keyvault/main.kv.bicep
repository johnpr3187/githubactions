...
// az login
// az group create --name rgmkv --location australiasoutheast
...
param objectId string = '83ec4bbd-fec2-46ca-8aa1-1f3b23c15e83'  //johnpr@microsoft.com
...
param secretName string = 'vmpassword'

//@description('Specifies the value of the secret that you want to create.')
@secure()
param secretValue string = 'freddofrog'
